...
var errors = {
  ...
  artifact: 'Artifact name can\'t be empty and must only contain alphanumeric chars and dashes.',
  parent_artifact: 'Parent artifact name must only contain alphanumeric chars and dashes.',
  ...
  package_name: 'Package name must only contain letters, spaces or dashes.'
};
