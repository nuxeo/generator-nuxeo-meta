...
public class Test<%= s.camelize(operation_name) %> {
    ...
    public void shouldCallTheOperation() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, <%= s.camelize(operation_name) %>.ID);
    ...
    public void shouldCallWithParameters() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, <%= s.camelize(operation_name) %>.ID, params);
